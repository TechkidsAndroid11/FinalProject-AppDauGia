...
import com.example.haihm.shelf.AuctionJoinedFragment;
...
public class AuctionFragment extends Fragment {
    ...
    private void setupJoinedAuctionTab(View view) {
        ...
        fragmentPagerItems.add(FragmentPagerItem.of("Đã tham gia", AuctionJoinedFragment.class, new Bundler().putBoolean(JOINED, true).get()));
