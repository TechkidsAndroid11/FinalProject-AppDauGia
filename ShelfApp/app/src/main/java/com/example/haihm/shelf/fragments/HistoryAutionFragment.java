 ...
 */
public class HistoryAutionFragment extends Fragment {
    private static final String TAG = "HistoryAutionFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_history_aution, container, false);
        setupUI();
        loadAuction();
        return view;
    }
